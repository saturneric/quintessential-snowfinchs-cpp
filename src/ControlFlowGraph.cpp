...
auto ControlFlowGraph::AddBlock(const BasicBlockPtr& bb) -> Vertex {
...
auto ControlFlowGraph::Blocks() const -> std::vector<BasicBlockPtr> {
...
auto ControlFlowGraph::Successors(int id) const -> std::vector<BasicBlockPtr> {
  std::vector<BasicBlockPtr> out;
